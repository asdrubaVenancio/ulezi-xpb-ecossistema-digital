...
const dirs = ['uploads/documents', 'uploads/receipts', 'uploads/contracts', 'uploads/logos', 'uploads/payments'];
dirs.forEach(dir => {
...
const fileFilter = (allowed) => (req, file, cb) => {
  ...
  if (allowed.includes(ext)) {
    ...
    cb(new Error(`Tipo de ficheiro não permitido. Permitidos: ${allowed.join(', ')}`), false);
  }
};
...
module.exports = { uploadDocument, uploadLogo, uploadPayment };
