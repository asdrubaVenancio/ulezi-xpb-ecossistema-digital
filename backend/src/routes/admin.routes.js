...
const { adminListEnrollments, assignCenter, viewEnrollmentDocument, reviewEnrollment } = require('../controllers/enrollment.controller');
...
router.delete('/training-centers/:id', authorize('admin'), deleteTrainingCenterV2);
...
router.put('/training-centers/:centerId/courses/:offeringId', updateCenterCourseOffering);
router.put('/centros/:centerId/cursos/:offeringId', updateCenterCourseOffering);
router.delete('/training-centers/:centerId/courses/:offeringId', deleteCenterCourseOffering);
router.delete('/centros/:centerId/cursos/:offeringId', deleteCenterCourseOffering);
